  ...
  return (
    <>
      <div className="flex w-full h-full text-white flex-col justify-center bg-gradient-to-r from-violet-700 to-pink-200">
        ...
        <div>
          <p className="font-bold  flex items-center justify-center flex-col gap-3 text-2xl text-center my-4">
            Join us now to start learning
          </p>

          <ul className=" p-3 font-bold text-center mx-96">
            <li className="py-1 ">
...
<footer className="bg-white dark:bg-gray-900">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center"> <a href="https://flowbite.com/">
        <div className="flex">
            ...
            <Hammer size={20} className="block md:hidden" />
          </div></a>
        </span>
